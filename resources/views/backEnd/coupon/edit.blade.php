...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('coupon.index')}}">Kupon</a> <a href="#" class="current">Ubah Kupon</a> </div>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form action="{{route('coupon.update',$edit_coupons->id)}}" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label for="amount_type" class="control-label">Type Jumlah</label>
                    ...
                    <div class="control-group">
                        <label for="expiry_date" class="control-label">Tgl Kadaluarsa</label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-success">Ubah Kupon</button>
                        </div>
                    </div>
                </form>
            </div>
