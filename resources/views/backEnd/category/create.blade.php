...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('category.index')}}">Kategory</a> <a href="{{route('category.create')}}" class="current">Tambah Kategory Baru</a> </div>
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
                    <h5>Tambah Kategroy Baru</h5>
                </div>
                <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="{{route('category.store')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
                        ...
                        <div class="control-group{{$errors->has('name')?' has-error':''}}">
                            <label class="control-label">Nama Kategory :</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label">Level Kategory :</label>
                        ...
                        <div class="control-group{{$errors->has('url')?' has-error':''}}">
                            <label class="control-label">URL (Mulai dengan http://) :</label>
                            <div class="controls">
