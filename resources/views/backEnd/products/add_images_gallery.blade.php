...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('product.index')}}">Produk</a> <a href="#" class="current">Tambah Gambar Gallery</a> </div>
                        ...
                        <ul class="recent-posts">
                            ...
                            <li>
                                <form action="{{route('image-gallery.store')}}" method="post" role="form" enctype="multipart/form-data">
                                    <legend>Dapat Menambahkan Gambar Multi</legend>
