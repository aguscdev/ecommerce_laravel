...
@section('content')
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Pengaturan</a> </div>
    </div>
    <!--End-breadcrumbs-->
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="{{url('/admin/update-pwd')}}" name="password_validate" id="password_validate" novalidate="novalidate">
                            ...
                            <div class="control-group">
                                <label class="control-label">Setujui password</label>
                                <div class="controls">
                                    <input type="password" name="pwdnew_confirm" id="pwdnew_confirm" />
                                </div>
                            </div>
                            <div class="form-actions">
                                <input type="submit" value="Perbarui Password" class="btn btn-success">
                            </div>
                        </form>
                    </div>
                </div>
