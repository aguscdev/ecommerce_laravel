...
@section('content')
    ...
    <section id="do_action">
        <div class="container">
            <div class="heading">
                <h3>Berikut Total Belanjaan Anda</h3>
                <p>Total Belanja Anda Adalah.</p>
            </div>
            <div class="row">
                <!-- <div class="col-sm-6">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="total_area">
                        ...
                        <div style="margin-left: 20px;"><a class="btn btn-default check_out" href="{{url('/check-out')}}">Periksa</a></div>
                    </div>
                </div>
            </div>
        </div>
