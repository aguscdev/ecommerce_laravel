...
class ProductsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('product.create')->with('message','Tambah produk berhasil!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('product.index')->with('message','Ubah produk berhasil!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('product.index')->with('message','Hapus produk berhasil!');
    }
