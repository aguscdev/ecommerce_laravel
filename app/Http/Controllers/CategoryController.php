...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('category.index')->with('message','Tambah kategory Berhasil!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('category.index')->with('message','Ubah kategory berhasil!');
    }
    ...
    public function destroy($id)
    {
        ...
        $delete->delete();
        return redirect()->route('category.index')->with('message','Hapus kategory Sukses!');
    }
}
