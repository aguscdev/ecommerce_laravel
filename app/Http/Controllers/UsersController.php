...
class UsersController extends Controller
{
    ...
    public function register(Request $request){
        ...
        return back()->with('message','Sudah Terdaftar!');
    }
    public function login(Request $request){
        ...
        if(Auth::attempt(['email'=>$input_data['email'],'password'=>$input_data['password']])){
            ...
            return back()->with('message','Akun Tidak Valid!');
        }
    }
    ...
    public function updateprofile(Request $request,$id){
        ...
        return back()->with('message','Perbaharui Profil!');
    ...
    public function updatepassword(Request $request,$id){
        ...
        if(Hash::check($input_data['password'],$oldPassword->password)){
            ...
            return back()->with('message','Sudah Ubah Password!');
        }else{
            return back()->with('oldpassword','Password Lama Tidak Benar!');
        }
    }
}
